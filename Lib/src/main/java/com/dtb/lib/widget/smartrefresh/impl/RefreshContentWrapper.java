...
import com.dtb.lib.widget.smartrefresh.util.ScrollBoundaryUtil;
...
import static com.dtb.lib.widget.smartrefresh.util.ScrollBoundaryUtil.isTransformedTouchPointInView;
...
public class RefreshContentWrapper implements RefreshContent {
    ...
    @Override
    public void setRefreshScrollBoundary(
