package com.dtb.lib.widget.smartrefresh.header;
...
import com.dtb.lib.widget.smartrefresh.header.bezierradar.RippleView;
import com.dtb.lib.widget.smartrefresh.header.bezierradar.RoundDotView;
import com.dtb.lib.widget.smartrefresh.header.bezierradar.RoundProgressView;
import com.dtb.lib.widget.smartrefresh.header.bezierradar.WaveView;
...
public class BezierRadarHeader extends FrameLayout implements RefreshHeader {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        setMinimumHeight(DensityExt.dp2px(100));
        /*          初始化headView         */
