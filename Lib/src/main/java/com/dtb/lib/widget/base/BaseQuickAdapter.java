 ...
 */
package com.dtb.lib.widget.base;
...
import com.dtb.lib.widget.animation.AlphaInAnimation;
import com.dtb.lib.widget.animation.BaseAnimation;
import com.dtb.lib.widget.animation.ScaleInAnimation;
import com.dtb.lib.widget.animation.SlideInBottomAnimation;
import com.dtb.lib.widget.animation.SlideInLeftAnimation;
import com.dtb.lib.widget.animation.SlideInRightAnimation;
import com.dtb.lib.widget.base.entity.IExpandable;
import com.dtb.lib.widget.base.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private void bindViewClickListener(final BaseViewHolder baseViewHolder) {
        ...
        if (getOnItemClickListener() != null) {
            view.setOnClickListener(v -> getOnItemClickListener().onItemClick(BaseQuickAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount()));
        }
        if (getOnItemLongClickListener() != null) {
            view.setOnLongClickListener(v -> getOnItemLongClickListener().onItemLongClick(BaseQuickAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount()));
        }
    }
