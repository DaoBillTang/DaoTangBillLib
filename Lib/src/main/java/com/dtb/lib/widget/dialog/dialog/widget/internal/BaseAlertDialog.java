package com.dtb.lib.widget.dialog.dialog.widget.internal;
...
import com.dtb.lib.widget.dialog.dialog.listener.OnBtnClickL;
import com.dtb.lib.widget.dialog.dialog.widget.base.BaseDialog;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog {
     ...
     * container
     */
    protected final LinearLayout ll_container;
    //title
    /**
     * title
     */
     ...
     * btn container
     */
    protected final LinearLayout ll_btns;
    /**
     * btns
     */
    protected final TextView tv_btn_left;
    protected final TextView tv_btn_right;
    protected final TextView tv_btn_middle;
    /**
     * btn text(按钮内容)
     */
    ...
    public void setUiBeforShow() {
        ...
        tv_btn_middle.setOnClickListener(v -> {
