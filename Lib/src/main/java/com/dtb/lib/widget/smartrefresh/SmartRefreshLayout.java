package com.dtb.lib.widget.smartrefresh;
...
import com.dtb.lib.ext.DensityExt;
import com.dtb.lib.widget.smartrefresh.api.DefaultRefreshFooterCreater;
import com.dtb.lib.widget.smartrefresh.api.DefaultRefreshHeaderCreater;
import com.dtb.lib.widget.smartrefresh.api.RefreshContent;
...
import com.dtb.lib.widget.smartrefresh.constant.DimensionStatus;
import com.dtb.lib.widget.smartrefresh.constant.RefreshState;
import com.dtb.lib.widget.smartrefresh.constant.SpinnerStyle;
import com.dtb.lib.widget.smartrefresh.footer.BallPulseFooter;
import com.dtb.lib.widget.smartrefresh.header.BezierRadarHeader;
import com.dtb.lib.widget.smartrefresh.header.FalsifyHeader;
import com.dtb.lib.widget.smartrefresh.impl.RefreshContentWrapper;
import com.dtb.lib.widget.smartrefresh.impl.RefreshFooterWrapper;
import com.dtb.lib.widget.smartrefresh.impl.RefreshHeaderWrapper;
import com.dtb.lib.widget.smartrefresh.listener.OnLoadmoreListener;
import com.dtb.lib.widget.smartrefresh.listener.OnMultiPurposeListener;
import com.dtb.lib.widget.smartrefresh.listener.OnRefreshListener;
import com.dtb.lib.widget.smartrefresh.util.ViscousFluidInterpolator;
...
import static com.dtb.lib.ext.DensityExt.dp2px;
...
public class SmartRefreshLayout extends ViewGroup
        implements NestedScrollingParent, NestedScrollingChild, RefreshLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.SmartRefreshLayout_srlHeaderHeight, DensityExt.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.SmartRefreshLayout_srlFooterHeight, DensityExt.dip2px(60));
