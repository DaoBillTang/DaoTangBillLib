package com.dtb.lib.widget.smartrefresh.footer;
...
import com.dtb.lib.widget.smartrefresh.footer.ballpulse.BallPulseView;
...
public class BallPulseFooter extends ViewGroup implements RefreshFooter {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setMinimumHeight(DensityExt.dp2px(60));
