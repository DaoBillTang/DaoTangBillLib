...
import com.dtb.lib.widget.base.listener.OnItemDragListener;
import com.dtb.lib.widget.base.listener.OnItemSwipeListener;
...
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
     ...
     * You should attach {@link ItemTouchHelper} which construct
     * with {@link ItemDragAndSwipeCallback} to the Recycler when you enable this.
     */
