package com.dtb.lib.widget.smartrefresh.header.bezierradar;
...
public class RoundProgressView extends View {
    ...
    private void initView() {
        ...
        mRadius = DensityExt.dip2px(20);
        mOutsideCircle = DensityExt.dip2px(7);
        mPath.setStrokeWidth(DensityExt.dip2px(3));
        mPantR.setStrokeWidth(DensityExt.dip2px(3));
