package com.dtb.lib.widget.dialog.dialog.widget.base;
...
import com.dtb.lib.widget.base.BaseAnimatorSet;
import com.dtb.lib.widget.dialog.dialog.utils.StatusBarUtils;
...
public abstract class BaseDialog<T extends BaseDialog<T>> extends Dialog {
     ...
     * <pre>
     *
     * public EditNameView onCreateView() {
     * EditNameView inflate = EditNameView.inflate(context, R.layout.dialog_share, null);
     * return inflate;
     * }
     * </pre>
     */
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        return isDismissAnim || isShowAnim || super.dispatchTouchEvent(ev);
    }
